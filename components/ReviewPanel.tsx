...
import { generateMonthlyReview, type ReviewItem } from '@/lib/reviewRules'

export default function ReviewPanel({ data }: { data: DashboardData }) {
  const [open, setOpen] = useState(true)
  const items = generateMonthlyReview(data)
