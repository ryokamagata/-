  ...
  return (
    <div className="space-y-4">
      <div className="bg-gray-800 rounded-xl p-5">
        <h3 className="text-base font-semibold text-gray-200 mb-4">予約経路 構成比</h3>
...
function Empty() {
  return <p className="text-gray-500 text-base text-center py-10">予約分析データがありません。BM同期を実行してください。</p>
}
